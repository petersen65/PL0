...
type (
	...
	assemblyCodeUnit struct {
		...
		OutputKind        OutputKind                                   `json:"output_kind"`         // kind of output that is produced with the assembly code
		DriverDisplayName string                                       `json:"driver_display_name"` // display name of an external compiler driver
...
func (u *assemblyCodeUnit) Print(print io.Writer, args ...any) error {
	...
	header := fmt.Sprintf(assemblyCodeHeader, u.TargetPlatform, u.DriverDisplayName)

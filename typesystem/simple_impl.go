...
var (
	...
	primitiveDataTypeCapabilities = map[PrimitiveDataType]DataTypeCapability{
		Integer64:  Integral | Numeric | Ordered | Equality | Bitwise | Negatable | OddCheckable,
		Integer32:  Integral | Numeric | Ordered | Equality | Bitwise | Negatable | OddCheckable,
		Integer16:  Integral | Numeric | Ordered | Equality | Bitwise | Negatable | OddCheckable,
		Integer8:   Integral | Numeric | Ordered | Equality | Bitwise | Negatable | OddCheckable,
		...
		Unsigned64: Integral | Numeric | Ordered | Equality | Bitwise | OddCheckable,
		Unsigned32: Integral | Numeric | Ordered | Equality | Bitwise | OddCheckable,
		Unsigned16: Integral | Numeric | Ordered | Equality | Bitwise | OddCheckable,
		Unsigned8:  Integral | Numeric | Ordered | Equality | Bitwise | OddCheckable,

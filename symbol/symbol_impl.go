...
func newScope(outer Scope) Scope {
	...
	// create the scope with an optional outer scope that can be nil
	inner := &scope{
		Outer:       outerScope,
		Inner:       make([]*scope, 0),
	...
	// if there is no outer scope, this is the outermost scope, so add built-in symbols.
	if outerScope == nil {
